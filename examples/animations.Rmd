...
Note: the charts on this page use `options(gglite.playback = TRUE)`, which
...
may want to use shorter durations and omit `options(gglite.playback = TRUE)`.
