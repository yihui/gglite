...
Use `style_view()` to apply background colors to the three regions so their
extents become visible. The `margin` argument sets the CSS container background,
`padding` colors the area where axis labels live, and `plot` colors the data
rendering area.
