...
g2(mtcars, x = 'mpg', y = 'hp', color = 'cyl') |>
  mark_point(style = list(shape = 'point', lineWidth = 0))
```
...
g2(mtcars, x = 'mpg', y = 'hp') |>
  mark_point(style = list(fill = 'steelblue', stroke = 'navy', lineWidth = 1))
```
...
g2() |>
  mark_force_graph(
    ...
    labels = list(list(text = 'id', fontSize = 10))
  )
```
...
g2() |>
  mark_tree(
    ...
    labels = list(list(text = 'name', fontSize = 10))
  )
```
