...
Transforms modify the data before rendering. Use `transform_of()` to apply
...
g2(df, x = 'x', y = 'y', color = 'product') |>
  mark_interval() |>
  transform_of('dodgeX') |>
  scale_of('color', range = c('#5470c6', '#91cc75')) |>
  title_of('Quarterly Sales', subtitle = 'By product line') |>
  interact('tooltip') |>
